...
def passed(submissions: list, lowest_passing: int):
    # list comprehension
    # add submission (first mention of "submission") to the new list from the original list ("for submission in submissions")
    # when condition met ("if submission.points >= lowest_passing")
